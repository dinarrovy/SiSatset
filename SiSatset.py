...
def MainMenu(items,columns,region,bin,username,choice=None,message=None): #DINAR/DEVINA/FEBY/FAQIH
    ...
    if choice == 5:
        ...
        tk.Label(root,font='Montserrat 10',text='Devina Firdha',fg='green').place(x=5,y=240)
        tk.Label(root,font='Montserrat 10',text='Dinar Ayu',fg='green').place(x=5,y=260)
        tk.Label(root,font='Montserrat 10',text='Mohammad Faqih',fg='green').place(x=5,y=280)
        tk.Label(root,font='Montserrat 10',text='Raka Febrian',fg='green').place(x=5,y=300)
        tk.Label(root,font='Montserrat 10',text='Shavira Feby',fg='green').place(x=5,y=320)
...
def SendGoods(items,columns,region,bin,username,kotaKeberangkatan=None,kotaTujuan=None):
    if kotaKeberangkatan == None and kotaTujuan == None:
        kotaKeberangkatan,kotaTujuan = bin[0].get(),bin[1].get()
        if kotaKeberangkatan.lower() == 'depok':
            kotaKeberangkatan = 'Bogor'
